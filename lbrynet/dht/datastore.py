...
#         """
#         return [peer for peer in self._dict[key] if self._getTime() - peer[3] < constants.dataExpireTimeout and peer[0].contact_is_good is not False]
#
#     def filter_expired_peers(self, key):
#         """
#         Returns only non-expired peers
#         """
#         return [peer for peer in self._dict[key] if self._getTime() - peer[3] < constants.dataExpireTimeout]
#
...
#             if compact_address not in [store_tuple[1] for store_tuple in self._dict[key]]:
